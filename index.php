                ...
                <div class="w-100pc md-w-40pc">
                    <div class="br-8 p-5 m-5">
                        <div class="flex justify-center items-center bg-indigo-lightest-10 white w-l5 h-l5 br-round mb-5"><i
                            ...
                            <div class="indigo-lightest fw-600 fs-m1 opacity-50">Completed Task 4, 5, 6, 7, 8, 9, and 10. Login details for admin: Email - ayeyidjan@gmail.com Password - hello</div>
